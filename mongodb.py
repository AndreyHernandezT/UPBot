...
col_intenciones.insert_many([
    {
        "tag": "saludos",
        "patterns": ["Hola", "¿como estas?","Hi","Buenos días","Buenas tardes", "Mucho gusto"],
        "responses": ["Hola. En que puedo ayudarte?", "Hola. Como puedo ayudarte?"],
        "context": [""]
    },
    {
        "tag": "despedida",
        "patterns": ["Adios", "Chao", "Nos vemos pronto"],
        "responses": ["Espero haberte ayudado", "Ten un lindo dia", "Nos vemos despues", "Cuidate"],
        "context": [""]
    },
    {
        "tag": "thanks",
        "patterns": ["Gracias", "Ok","Muchas gracias","Genial, gracias", "Me ayudo", "Gracias por la ayuda", "Genial", "wow", "increible"],
        "responses": ["Me alegra ayudar", "Cuando quieras!","Fue un placer, de nada", "Me alegra ayudarte"],
        "context": [""]
    },
    {
        "tag": "noanswer",
        "patterns": [""],
        "responses": ["Perdon, no te entiendo", "Dame mas informacion por favor", "No lo entendi, repitelo por favor"],
        "context": [""]
    },
    {
        "tag": "name1",
        "patterns": ["Como te llamas?","Tienes nombre?", "Que nombre tienes?"],
        "responses": ["Llamame UPBot","Hola, soy UPBot, encantado de ayudarte","Sou UPBot, estoy para lo que necesites"],
        "context": [""]
    },
    {
        "tag": "name",
        "patterns": ["Me llamo ", "Mi nombre es ","Soy "],
        "responses": ["Encantado de conocerte. Como puedo ayudarte hoy?", "Tienes un lindo nombre. Como puedo ayudarte?"],
        "context": [""]
    },
    {
        "tag": "date",
        "patterns": ["Salimos?", "Podemos tener una cita?","Te quiero","Te amo"],
        "responses": ["Aaw, es muy lindo de tu parte. Lastima que sea un robot"],
        "context": [""]
    },
    {
        "tag": "fav",
        "patterns": ["Necesito un favor", "puedes ayudarme?","Necesito ayuda"],
        "responses": ["Claro, estoy para ayudarte","Me encanta ayudar. Como puedo ayudarte?","Estoy para lo que necesites"],
        "context": [""]
    },
    {
        "tag": "need",
        "patterns": ["Te necesito","Necesito de tu ayuda"],
        "responses": ["Estoy para eso, ayudar"],
        "context": [""]
    },
    {
        "tag": "horario",
        "patterns": ["que horario manejan?","cual es el horario de atencion","horario de atencion"],
        "responses": ["Nuestro horario de atencion es de 7:30am a 12:30pm y de 1:30pm a 5:30pm"],
        "context": [""]
    },
    {
        "tag": "informacion",
        "patterns": ["mas informacion","donde puedo encontrar mas informacion"],
        "responses": ["Escribenos al correo info@upbbga para mas informacion"],
        "context": [""]
    },
    {
        "tag": "direccion",
        "patterns": ["donde estan ubicados","direccion de la universidad"],
        "responses": ["La direccion de UPB Bucaramanga es Campus Universitario Km 7 via Piedecuesta. Te esperamos"],
        "context": [""]
    },
    {
        "tag": "bienestarUni",
        "patterns": ["que es bienestar universitario","bienestar universitario"],
        "responses": ["En Bienestar Universitario facilitamos el aprendizaje significativo a través de experiencias reflexivas y formativas en: SaludGestión de las emociones y las relaciones. Desempeño académico y profesional. Talentos artísticos y deportivos"],
        "context": [""]
    },
    {
        "tag": "sentiment",
